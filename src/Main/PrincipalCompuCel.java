			...
			try {
				...
				case 1:
					...
					while (true) {
						...
						System.out.println("3.-Distribuci�n linux");
						...
						while (true) {
							...
							if (selecSO > 0 && selecSO <= 4) {
								...
								case 2:
									...
									break;
								case 3:
									compuTemp.setSo("Distribuci�n linux");
									break;
								case 4:
				...
				case 8:
					...
					imp.guardarRegistro(
							new Computadora("Laptop", "Lenovo", "LN789", "Distribuci�n linux", 13500.75f, 5));
				...
				System.out.println("Entrada inv�lida. Por favor ingresa datos v�lidos.");
